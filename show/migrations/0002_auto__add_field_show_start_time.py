...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.start_time'
        db.add_column('show_show', 'start_time',
                      self.gf('django.db.models.fields.TimeField')(auto_now_add=True, default=datetime.datetime(2013, 5, 24, 0, 0), db_index=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Show.start_time'
    ...
    models = {
        ...
        'preferences.showpreferences': {
            'Meta': {'object_name': 'ShowPreferences', '_ormbases': ['preferences.Preferences']},
        ...
        'show.appearance': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'appearances'", 'to': "orm['jmbo_calendar.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'show_contributor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'appearances'", 'to': "orm['show.Contributor']"})
        },
        'show.contributor': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'Contributor', '_ormbases': ['jmbo.ModelBase']},
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'}),
            'profile': ('ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
            'shows': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'show_contributors'", 'symmetrical': 'False', 'through': "orm['show.Credit']", 'to': "orm['show.Show']"})
        },
        'show.credit': {
            'Meta': {'object_name': 'Credit'},
            'contributor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'credits'", 'to': "orm['show.Contributor']"}),
            'credit_option': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['show.CreditOption']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'show': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'credits'", 'to': "orm['show.Show']"})
        },
        'show.creditoption': {
            ...
            'show_preferences': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['preferences.ShowPreferences']"})
        },
        'show.radioshow': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'RadioShow', '_ormbases': ['show.Show']},
            'show_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['show.Show']", 'unique': 'True', 'primary_key': 'True'})
        },
        'show.show': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'Show', '_ormbases': ['jmbo.ModelBase']},
            'content': ('ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
            'contributors': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['show.Contributor']", 'through': "orm['show.Credit']", 'symmetrical': 'False'}),
            'end': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'}),
            'repeat': ('django.db.models.fields.CharField', [], {'default': "'does_not_repeat'", 'max_length': '64', 'db_index': 'True'}),
            'repeat_until': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'start_time': ('django.db.models.fields.TimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        'sites.site': {
